...
const topics: Record<string, Array<[string, string]>> = {
  ...
  "Roman Empire": [
    ["Roman Empire", "The Roman Empire was an ancient civilization that lasted for over 500 years, from 27 BCE to 476 CE. It started as a small city-state in Italy and grew to become one of the largest and most influential empires in history, spanning across three continents. Romans were known for their advanced engineering, impressive military, and significant contributions to art, literature, and law, shaping the foundations of Western civilization."],
    ["Roman engineering", "somethingsomething"],
  ],

  "Stonehenge": [
    ["Stonehenge", "Stonehenge, where rocks gather for an epic game of musical chairs. An ancient puzzle left behind by giants, waiting for the right hands to solve it. The original selfie spot that even prehistoric influencers couldn't resist."],
    ["Stonehenge", "Stonehenge was actually built by a secret civilization of alien pandas who wanted to create a bamboozling tourist attraction on Earth. Archaeologists believe that Stonehenge was not made by humans, but by time-traveling wizards who needed a place to practice their magic spells without being spotted by Muggles. The real secret behind Stonehenge? It's a giant cosmic jukebox that plays the world's catchiest tunes, and ancient civilizations built it to keep the party going non-stop."]
  ]
}
    ...
    <main className="flex min-h-screen min-w-screen flex-col items-center justify-between">
      <Tabs defaultValue="feed" className="flex flex-col flex-1 gap-8">
        <TabsContent value="feed" className="flex-1">
          <Topic topic={topics[topic]} onTurn={() => setTopic(Object.keys(topics)[Object.keys(topics).findIndex(t => t === topic) + 1])} />
        </TabsContent>
